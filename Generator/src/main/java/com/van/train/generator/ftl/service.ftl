package com.van.train.${module}.service;
...
import com.van.train.${module}.domain.${Domain};
import com.van.train.${module}.domain.${Domain}Example;
import com.van.train.${module}.mapper.${Domain}Mapper;
